...
// Portfolio Data
const websiteTypes: PortfolioItem[] = [
  {
    id: 1,
  ...
  },
  {
    ...
    description: "Local image converter using stable diffuser model",
...
const GlobalSpotlight: React.FC<{
  ...
  useEffect(() => {
    ...
    const handleMouseLeave = () => {
      ...
      gridRef.current?.querySelectorAll('.portfolio-card').forEach(card => {
        (card as HTMLElement).style.setProperty('--glow-intensity', '0');
      });
    ...
    <>
      <style>
        {`
          ...
          .portfolio-card--border-glow::after {
            content: '';
            position: absolute;
            inset: 0;
            padding: 6px;
          ...
          .portfolio-card--border-glow:hover::after {
            opacity: 1;
          }
          
          .portfolio-card--border-glow:hover {
      ...
      <div className="py-20 bg-gradient-to-br from-[#252525] to-[#1a1a1a] min-h-screen">
        <div className="w-full mx-auto px-4 sm:px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-6xl font-bold text-[#e8e8e8] mb-8">
          ...
          <div ref={gridRef} className="bento-section">
            <div className="portfolio-grid">
              {websiteTypes.map((item) => (
                <ParticleCard
                  key={item.id}
                  className="portfolio-card portfolio-card--border-glow"
                  disableAnimations={shouldDisableAnimations}
                    ...
                    <div className="portfolio-buttons">
                      ...
                      {item.apk && (
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="portfolio-button button-success"
                        >
